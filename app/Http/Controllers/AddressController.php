...
class AddressController extends Controller
{
    ...
    {
        //
        $addresses = WorkPlace::paginate(6);
        ...
        return view('back_end.page_address.index')->with($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->intended('/so-manage/address');
    }
     ...
     *
     * @param  \App\WorkPlace $addresses
     * @return \Illuminate\Http\Response
     */
    public function show(WorkPlace $addresses)
    {
        //
    }
    ...
    public function edit($id)
    {
        ...
        return view('back_end.page_address.edit')->with($data);
    }
