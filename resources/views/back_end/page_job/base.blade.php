                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-10">
                                <div class="company-content">
                                    <h4 style="height: 60px;line-height: 25px;" class="clear-def">{{$row->title}}</h4>
                                    ...
                                    <form class="row" method="POST"
                                          action="{{ route('job.destroy', ['id' => $row->id]) }}"
                                        ...
                                        <a href="{{ route('job.edit', ['id' => \App\Http\Controllers\MyUtility::my_encrypt($row->id,true)]) }}"
                                        ...
                                        <a class="btn-primary btn-id"
                                           href="/so-manage/job/{{\App\Http\Controllers\MyUtility::my_encrypt($row->id,true)}}"><span
