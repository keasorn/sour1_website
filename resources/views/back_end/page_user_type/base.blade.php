<div class="col-md-12 margin-25-0">
    <table class="custom-table-m table">
        ...
        @foreach($userTypes as $row)
            ...
            <tr>
                ...
                <td class="page-header">
                    ...
                    <form class="row" method="POST"
                          action="{{ route('user-type.destroy', ['id' => $row->id]) }}"
                        ...
                        <a href="{{ route('user-type.edit', ['id' => \App\Http\Controllers\MyUtility::my_encrypt($row->id,true)]) }}"
            ...
            <?php
            $rst = clone $users;
            $uss = $rst->where("user_type", $row->id)->get();
            ?>
            @foreach($uss as $rw)
