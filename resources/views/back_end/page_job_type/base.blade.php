<div class="col-md-12 margin-25-0">
    <table class="custom-table-m table">
        ...
        @foreach($jobTypes as $row)
            ...
            <tr>
                ...
                <td class="page-header">
                    ...
                    <form class="row" method="POST"
                          action="{{ route('job-type.destroy', ['id' => $row->id]) }}"
                        ...
                        <a href="{{ route('job-type.edit', ['id' => \App\Http\Controllers\MyUtility::my_encrypt($row->id,true)]) }}"
            ...
            <?php
            $rst = clone $users;
            $uss = $rst->where("job_type", $row->id)->get();
            ?>
            @foreach($uss as $rw)
